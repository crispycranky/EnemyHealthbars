...
local widgets = {
	...
	},
	{
		...
		sub_widgets = {
			...
			},
			{
				...
				type = "checkbox",
				default_value = true,
				tooltip = "Show healthbars for all captain enemies (Purple color).",
			},
		},
	},
	{
	...
	},
	{
		...
		sub_widgets = {
			...
			{
				setting_id = "special_disabler_color_r",
				type = "numeric",
				default_value = 200,
				range = {0, 255},
				tooltip = "Red component for disabler specials (Mutants, Hounds, Flamers, etc.)",
			},
			{
				setting_id = "special_disabler_color_g",
				type = "numeric",
				default_value = 0,
				range = {0, 255},
				tooltip = "Green component for disabler specials",
			},
			{
				setting_id = "special_disabler_color_b",
				type = "numeric",
				default_value = 255,
				range = {0, 255},
				tooltip = "Blue component for disabler specials",
			},
		},
	},
}
